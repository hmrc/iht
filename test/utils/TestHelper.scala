...
object TestHelper {
  ...
  val JsListCases=NinoBuilder.replacePlaceholderNinoWithDefault(AcknowledgeRefGenerator.replacePlaceholderAckRefWithDefault("""{
                              "deathEvents": [
                              {
  ...
  val JsListCasesNoNINO=NinoBuilder.replacePlaceholderNinoWithDefault(AcknowledgeRefGenerator.replacePlaceholderAckRefWithDefault("""{
                              "deathEvents": [
                              {
                               "acknowledgmentReference": "<ACKREF>",
                                "ihtReference": "1234567890ABCDE",
  ...
  val JsSampleCaseDetailsString=NinoBuilder.replacePlaceholderNinoWithDefault(AcknowledgeRefGenerator.replacePlaceholderAckRefWithDefault("""{
                                    "acknowledgmentReference": "<ACKREF>",
                                    "ihtReference":"1234567890ABCDE",
                                    "event": {
                                      "eventType": "Death",
